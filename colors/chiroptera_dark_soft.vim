...
let g:colors_name = 'chiroptera_dark_soft'
...
let s:fg_ignore      = {'cterm': '238'     , 'gui': '#52514d'     }
...
let s:bg_normal      = {'cterm': '236'     , 'gui': '#3c3b38'     }
let s:bg_highlight   = {'cterm': '235'  , 'gui': '#32302e'  }
let s:bg_mark        = {'cterm': '238'       , 'gui': '#52514d'       }
let s:bg_red         = {'cterm': '88'        , 'gui': '#7d0006'        }
let s:bg_green       = {'cterm': '58'      , 'gui': '#3d3d00'      }
let s:bg_blue        = {'cterm': '23'       , 'gui': '#004245'       }
let s:bg_yellow      = {'cterm': '58'     , 'gui': '#5b3100'     }
let s:bg_magenta     = {'cterm': '53'    , 'gui': '#681f45'    }
let s:bg_cyan        = {'cterm': '235'       , 'gui': '#004434'       }
let s:ui_normal      = {'cterm': '238'     , 'gui': '#52514d'     }
let s:ui_highlight   = {'cterm': '235'  , 'gui': '#32302e'  }
