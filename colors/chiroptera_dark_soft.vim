...
let s:fg_ignore      = {'cterm': '239'     , 'gui': '#575755'     }
...
let s:bg_normal      = {'cterm': '237'     , 'gui': '#424141'     }
let s:bg_highlight   = {'cterm': '236'  , 'gui': '#373737'  }
let s:bg_mark        = {'cterm': '239'       , 'gui': '#575755'       }
let s:bg_red         = {'cterm': '88'        , 'gui': '#8a0009'        }
let s:bg_green       = {'cterm': '58'      , 'gui': '#444400'      }
let s:bg_blue        = {'cterm': '23'       , 'gui': '#004a4c'       }
let s:bg_yellow      = {'cterm': '58'     , 'gui': '#653600'     }
let s:bg_magenta     = {'cterm': '53'    , 'gui': '#70264b'    }
let s:bg_cyan        = {'cterm': '23'       , 'gui': '#004b3a'       }
let s:ui_normal      = {'cterm': '239'     , 'gui': '#575755'     }
let s:ui_highlight   = {'cterm': '236'  , 'gui': '#373737'  }
