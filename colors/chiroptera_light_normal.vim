...
let s:fg_ignore      = {'cterm': '249'     , 'gui': '#c1bfb5'     }
...
let s:bg_normal      = {'cterm': '188'     , 'gui': '#dcd9ce'     }
let s:bg_highlight   = {'cterm': '254'  , 'gui': '#eae7db'  }
let s:bg_mark        = {'cterm': '249'       , 'gui': '#c1bfb5'       }
let s:bg_red         = {'cterm': '224'        , 'gui': '#fecec5'        }
let s:bg_green       = {'cterm': '185'      , 'gui': '#e3de64'      }
let s:bg_blue        = {'cterm': '152'       , 'gui': '#a4e5e8'       }
let s:bg_yellow      = {'cterm': '223'     , 'gui': '#fed1ab'     }
let s:bg_magenta     = {'cterm': '224'    , 'gui': '#fecce0'    }
let s:bg_cyan        = {'cterm': '116'       , 'gui': '#98e9ce'       }
let s:ui_normal      = {'cterm': '249'     , 'gui': '#c1bfb5'     }
