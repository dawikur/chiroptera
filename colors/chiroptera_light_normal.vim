...
let g:colors_name = 'chiroptera_light_normal'
...
let s:fg_ignore      = {'cterm': '250'     , 'gui': '#c3c1b8'     }
...
let s:bg_normal      = {'cterm': '188'     , 'gui': '#dddacf'     }
let s:bg_highlight   = {'cterm': '254'  , 'gui': '#eae7db'  }
let s:bg_mark        = {'cterm': '250'       , 'gui': '#c3c1b8'       }
let s:bg_red         = {'cterm': '224'        , 'gui': '#fed0c6'        }
let s:bg_green       = {'cterm': '185'      , 'gui': '#e4df65'      }
let s:bg_blue        = {'cterm': '152'       , 'gui': '#a5e6e9'       }
let s:bg_yellow      = {'cterm': '223'     , 'gui': '#fed2ae'     }
let s:bg_magenta     = {'cterm': '224'    , 'gui': '#fecde1'    }
let s:bg_cyan        = {'cterm': '116'       , 'gui': '#99eacf'       }
let s:ui_normal      = {'cterm': '250'     , 'gui': '#c3c1b8'     }
let s:ui_highlight   = {'cterm': '254'  , 'gui': '#eae7db'  }
