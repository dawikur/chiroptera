...
let g:colors_name = 'chiroptera_light_hard'
...
let s:fg_ignore      = {'cterm': '251'     , 'gui': '#d0cec3'     }
...
let s:bg_normal      = {'cterm': '254'     , 'gui': '#eae7db'     }
let s:bg_highlight   = {'cterm': '255'  , 'gui': '#f7f5e7'  }
let s:bg_mark        = {'cterm': '251'       , 'gui': '#d0cec3'       }
let s:bg_red         = {'cterm': '224'        , 'gui': '#fee1db'        }
let s:bg_green       = {'cterm': '227'      , 'gui': '#f2ec71'      }
let s:bg_blue        = {'cterm': '159'       , 'gui': '#b2f3f6'       }
let s:bg_yellow      = {'cterm': '224'     , 'gui': '#fee2cc'     }
let s:bg_magenta     = {'cterm': '225'    , 'gui': '#fedfec'    }
let s:bg_cyan        = {'cterm': '158'       , 'gui': '#a6f8dc'       }
let s:ui_normal      = {'cterm': '251'     , 'gui': '#d0cec3'     }
let s:ui_highlight   = {'cterm': '255'  , 'gui': '#f7f5e7'  }
