...
let s:fg_ignore      = {'cterm': '251'     , 'gui': '#cfccc1'     }
...
let s:bg_mark        = {'cterm': '251'       , 'gui': '#cfccc1'       }
let s:bg_red         = {'cterm': '224'        , 'gui': '#fee0da'        }
let s:bg_green       = {'cterm': '227'      , 'gui': '#f1eb71'      }
let s:bg_blue        = {'cterm': '159'       , 'gui': '#b1f2f5'       }
let s:bg_yellow      = {'cterm': '224'     , 'gui': '#fee2cb'     }
let s:bg_magenta     = {'cterm': '225'    , 'gui': '#fedeeb'    }
let s:bg_cyan        = {'cterm': '158'       , 'gui': '#a5f7db'       }
let s:ui_normal      = {'cterm': '251'     , 'gui': '#cfccc1'     }
