...
let s:fg_ignore      = {'cterm': '237'     , 'gui': '#474643'     }
...
let s:bg_normal      = {'cterm': '235'     , 'gui': '#32302e'     }
let s:bg_highlight   = {'cterm': '234'  , 'gui': '#272625'  }
let s:bg_mark        = {'cterm': '237'       , 'gui': '#474643'       }
let s:bg_red         = {'cterm': '52'        , 'gui': '#6a0001'        }
let s:bg_green       = {'cterm': '235'      , 'gui': '#333200'      }
let s:bg_blue        = {'cterm': '235'       , 'gui': '#003739'       }
let s:bg_yellow      = {'cterm': '52'     , 'gui': '#4b2800'     }
let s:bg_magenta     = {'cterm': '53'    , 'gui': '#5c123a'    }
let s:bg_cyan        = {'cterm': '235'       , 'gui': '#00382a'       }
let s:ui_normal      = {'cterm': '237'     , 'gui': '#474643'     }
let s:ui_highlight   = {'cterm': '234'  , 'gui': '#272625'  }
