...
let s:fg_ignore      = {'cterm': '237'     , 'gui': '#424141'     }
...
let s:bg_normal      = {'cterm': '235'     , 'gui': '#2d2d2e'     }
let s:bg_highlight   = {'cterm': '234'  , 'gui': '#232424'  }
let s:bg_mark        = {'cterm': '237'       , 'gui': '#424141'       }
let s:bg_red         = {'cterm': '52'        , 'gui': '#630100'        }
let s:bg_green       = {'cterm': '234'      , 'gui': '#302f00'      }
let s:bg_blue        = {'cterm': '235'       , 'gui': '#003335'       }
let s:bg_yellow      = {'cterm': '52'     , 'gui': '#462500'     }
let s:bg_magenta     = {'cterm': '53'    , 'gui': '#580e37'    }
let s:bg_cyan        = {'cterm': '234'       , 'gui': '#003527'       }
let s:ui_normal      = {'cterm': '237'     , 'gui': '#424141'     }
let s:ui_highlight   = {'cterm': '234'  , 'gui': '#232424'  }
